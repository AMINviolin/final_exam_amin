    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=False)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('which_comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='blogs.comments')),
            ],
            options={
                'ordering': ('-created_date',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('second_image', models.ImageField(default='blog-2.jpg', upload_to='blog')),
                ('auther_img', models.ImageField(default='bauth.jpg', upload_to='blog')),
                ('auther_bio', models.TextField(blank=True, null=True)),
